...
const NODES: ArchitectureNode[] = [
  {
    ...
    codeSnippet: {
      title: "rateLimiter.ts (Algoritma Token Bucket)",
      lang: "typescript",
  ...
  },
  {
    ...
    codeSnippet: {
      title: "circuitBreaker.ts (Toleransi Kegagalan)",
      lang: "typescript",
  ...
  },
  {
    ...
    codeSnippet: {
      title: "cacheAside.ts (Pola Cache Atomik)",
      lang: "typescript",
...
export function SystemArchitecture() {
  ...
  return (
    <section id="architecture" className="py-24 relative z-10 border-t border-white/[0.08] scroll-mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {NODES.map((node, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 mt-3 text-[11px] font-mono text-cyan-400">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start glass-panel rounded-3xl p-6 sm:p-8 border border-white/[0.08]">
          {/* Left Spec Details (6 cols) */}
          <div className="lg:col-span-6 space-y-6">
            <div>
              <div className="flex items-center gap-2 text-xs font-mono text-cyan-400 font-semibold mb-1 uppercase tracking-wider">
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              <div className="p-3.5 rounded-xl bg-black/40 border border-white/[0.06]">
                <span className="text-[10px] font-mono text-slate-400 uppercase block">Target Latensi SLA</span>
                <span className="text-base font-mono font-bold text-cyan-300">{activeNode.latencySla}</span>
              </div>
              <div className="p-3.5 rounded-xl bg-black/40 border border-white/[0.06]">
                <span className="text-[10px] font-mono text-slate-400 uppercase block">Kapasitas Throughput</span>
                <span className="text-base font-mono font-bold text-emerald-400">{activeNode.throughput}</span>
              </div>
              <div className="p-3.5 rounded-xl bg-black/40 border border-white/[0.06] col-span-2">
                <span className="text-[10px] font-mono text-slate-400 uppercase block">Model Konkurensi</span>
                <span className="text-xs font-mono font-medium text-slate-200">{activeNode.concurrencyModel}</span>
              </div>
              <div className="p-3.5 rounded-xl bg-black/40 border border-white/[0.06] col-span-2">
                <span className="text-[10px] font-mono text-slate-400 uppercase block">Strategi Toleransi Kegagalan</span>
                <span className="text-xs font-mono font-medium text-slate-200">{activeNode.failureStrategy}</span>
              </div>
            </div>

            {/* Architectural Trade-off Note */}
            <div className="p-4 rounded-xl bg-cyan-950/30 border border-cyan-500/20 text-xs font-sans text-cyan-100/90 leading-relaxed flex items-start gap-2.5">
          ...
          <div className="lg:col-span-6">
            <div className="rounded-2xl bg-[#090b12] border border-white/[0.08] overflow-hidden shadow-2xl">
              ...
              <div className="px-4 py-3 bg-[#0d101a] border-b border-white/[0.08] flex items-center justify-between">
                ...
                <span className="text-[10px] font-mono text-cyan-400 uppercase font-semibold px-2 py-0.5 rounded bg-cyan-950/60 border border-cyan-500/30">
                  {activeNode.codeSnippet.lang}
                </span>
              </div>

              {/* Code Editor Body */}
              <pre className="p-5 font-mono text-xs text-slate-200 overflow-x-auto leading-relaxed selection:bg-cyan-500/30">

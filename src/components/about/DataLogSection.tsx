...
export function DataLogSection() {
  ...
  return (
    <section id="about" className="py-24 relative z-10 border-t border-white/[0.08] scroll-mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            {/* Executive Bio Card */}
            <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-white/[0.08] space-y-5">
